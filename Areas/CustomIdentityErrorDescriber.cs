...
public class CustomIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError ConcurrencyFailure() { return new IdentityError { Code = nameof(ConcurrencyFailure), Description = "*Ошибка оптимистичной конкурентности, объект был изменен." }; }
